      ...
      <main className="inner-page">
        ...
        <section className="contact-page section">
          <div className="contact-details">
            ...
            <p>We serve homes and businesses across Rajkot with fast, careful installation.</p>
            <a href="tel:+918229006831" className="detail-card">
              <FiPhone /><span><strong>Call us</strong>8229006831</span>
            </a>
            <div className="detail-card"><FiMapPin /><span><strong>Our location</strong>Rajkot, Gujarat</span></div>
